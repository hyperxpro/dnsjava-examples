...
/**
 *
 * <h1> AAAA Record DNS Query </h1>
 */
public final class AAAAExample {

    public static void main(String[] args) throws IOException {
        // Craft a new query message
        Message message = Message.newQuery(Record.newRecord(Name.fromString("www.google.com."), Type.AAAA, DClass.IN));
