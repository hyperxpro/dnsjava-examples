...
/**
 *
 * <h1> TXT Record DNS Query </h1>
 */
public final class TXTExample {

    public static void main(String[] args) throws IOException {
        // Craft a new query message
        Message message = Message.newQuery(Record.newRecord(Name.fromString("txt.dnsjava.aayushatharva.com."), Type.TXT, DClass.IN));
