 ...
 * under the License.
 */
package com.aayushatharva.oss.dnsjava.examples.transport;
...
public final class UdpTransport {
    ...
    public static byte[] sendAndReceive(InetSocketAddress socketAddress, byte[] data) throws IOException {
