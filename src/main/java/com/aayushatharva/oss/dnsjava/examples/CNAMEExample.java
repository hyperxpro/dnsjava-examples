...
/**
 *
 * <h1> CNAME Record DNS Query </h1>
 */
public final class CNAMEExample {

    public static void main(String[] args) throws IOException {
        // Craft a new query message
        Message message = Message.newQuery(Record.newRecord(Name.fromString("cname.dnsjava.aayushatharva.com."), Type.CNAME, DClass.IN));
